...
namespace Kyle.Flooding
{
    ...
    public sealed class FloodRegionData : ScriptableObject, IOccupancyBakeData
    {
        ...
        IReadOnlyList<int> IOccupancyBakeData.OccupiedCellIndices =>
            OccupiedCellIndices;

        IReadOnlyList<Vector3> IOccupancyBakeData.PresentationBoundaryVertices =>
            PresentationBoundaryVertices;

        IReadOnlyList<int> IOccupancyBakeData.PresentationBoundaryTriangles =>
            PresentationBoundaryTriangles;
